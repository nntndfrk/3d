...
export let Controller = function(three, model, camera, element, controls, hud) {
    ...
    function checkWallsAndFloors(event?) {
        ...
        if (state === states.UNSELECTED && mouseoverObject == null) {
            ...
            const floorIntersects = scope.getIntersections(
    ...
    this.getIntersections = (vec2, objects, filterByNormals, onlyVisible, recursive, linePrecision) => {
